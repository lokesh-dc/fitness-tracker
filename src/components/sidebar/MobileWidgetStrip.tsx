...
export function MobileWidgetStrip({ streak, workoutsThisMonth, sessionsDone, nextWorkout }: MobileWidgetStripProps) {
  const cards = [
    ...
    { title: "Next", value: nextWorkout, icon: Play, color: "text-orange-500" },
  ];
        ...
        return (
          <Container 
            ...
            className={cn(
              ...
              isStreak 
                ? "bg-gradient-to-br from-orange-500 to-orange-600 border-none shadow-[0_10px_20px_rgba(249,115,22,0.2)]" 
                : "border-orange-500/5"
            )}
          >
