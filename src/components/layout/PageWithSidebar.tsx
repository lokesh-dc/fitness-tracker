...
export default function PageWithSidebar({ children, sidebar, mobileWidgets }: PageWithSidebarProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 w-full">
      ...
      <div className="flex-1 min-w-0 space-y-8">
        ...
        {mobileWidgets && (
          <div className="lg:hidden flex gap-4 overflow-x-auto pb-4 -mx-4 px-4 scrollbar-none snap-x h-[120px]">
            {mobileWidgets}
          </div>
        )}
