  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header className="px-6 py-8 flex justify-between items-center">
        <div>
          <p className="text-foreground/40 text-xs font-bold uppercase tracking-[0.2em] mb-1">
        ...
        <div className="flex items-center space-x-3">
          <ThemeToggle />
          <div className="glass-button w-12 h-12 rounded-2xl border-foreground/10 overflow-hidden">
            <img 
      ...
      <main className="flex-1 px-6 space-y-8 max-w-4xl mx-auto w-full pb-12">
        <section>
          <div className="flex justify-between items-end mb-4">
            <h2 className="text-lg font-bold text-foreground tracking-tight">Today&apos;s Stats</h2>
            <Link href="#" className="text-xs font-bold text-orange-500 hover:underline flex items-center">
        ...
        <section className="space-y-4">
          <div className="flex justify-between items-end">
            <h2 className="text-lg font-bold text-foreground tracking-tight">Your Plan</h2>
          ...
          {plan ? (
            ...
            <div className="glass-card border-dashed border-foreground/10 flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-foreground/60 text-sm font-medium mb-1">No workout scheduled for today</p>
              <p className="text-foreground/40 text-xs">Tap to create a new session or set up a plan.</p>
            </div>
          )}
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
           <GlassCard className="flex items-center justify-between group cursor-pointer">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-foreground">Log Weight</h3>
                  <p className="text-[10px] text-foreground/40 font-medium uppercase tracking-wider">Update trend</p>
                </div>
              </div>
           ...
           <Link href="/analytics" className="contents">
             <GlassCard className="flex items-center justify-between group cursor-pointer">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-foreground">View Progress</h3>
                    <p className="text-[10px] text-foreground/40 font-medium uppercase tracking-wider">All-time PRs</p>
                  </div>
                </div>
                <ChevronRight className="w-4 h-4 text-foreground/20 group-hover:text-foreground transition-colors" />
             </GlassCard>
