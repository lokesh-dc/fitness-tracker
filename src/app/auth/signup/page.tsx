    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center">
          ...
          <p className="text-white/40 text-sm font-bold uppercase tracking-widest mt-1">Start your journey today</p>
        </div>
        ...
        <GlassCard className="p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : <><span className="mr-2">Join Now</span> <ArrowRight className="w-4 h-4" /></>}
            </button>
          </form>
        </GlassCard>
        ...
        <p className="text-center text-white/40 text-xs font-bold">
          ...
          <Link href="/auth/signin" className="text-orange-500 hover:underline">Log In</Link>
        </p>
      </div>
    </div>
  );
