						...
						return (
							<div
								...
								className={cn(
									...
									inPlan &&
										!logged &&
										"bg-foreground/[0.03] border border-foreground/[0.05] hover:bg-foreground/[0.06]",
									inPlan &&
										logged &&
										"bg-orange-500 border border-orange-400 shadow-[0_5px_15px_rgba(249,115,22,0.2)] hover:scale-110 z-10",
								)}>
								...
								<span
									className={cn(
										...
										logged ? "text-black" : "text-foreground/40",
									)}>
									{format(date, "d")}
								</span>
