...
import { User, Bell, Shield, CircleHelp, LogOut, ChevronRight, Settings, CreditCard } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 px-6 space-y-6 max-w-2xl mx-auto w-full pb-12">
        <GlassCard className="flex items-center space-x-6 py-8">
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground">Lokesh Choudhary</h2>
            <p className="text-foreground/40 text-sm font-medium">Joined March 2024</p>
          ...
          <section key={idx} className="space-y-3">
            ...
            <div className="space-y-2">
              {section.items.map((item, itemIdx) => (
                <GlassCard key={itemIdx} className="p-4 flex items-center justify-between group cursor-pointer hover:bg-foreground/5 transition-all">
